...
class IMUActivity{
  public:
    ...
    void onServiceReset(const std_srvs::srv::Trigger::Request::SharedPtr req, std_srvs::srv::Trigger::Response::SharedPtr res, const rclcpp::Logger& logger);
    void onServiceCalibrate(const std_srvs::srv::Trigger::Request::SharedPtr req, std_srvs::srv::Trigger::Response::SharedPtr res, const rclcpp::Logger& logger);

  private:
    bool reset(const rclcpp::Logger& logger);
